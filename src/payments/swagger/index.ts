export * from './payment-methods.tags.swagger';
...
export * from './payment-methods.create.swagger';

export * from './payment-methods.list.swagger';

export * from './payment-methods.remove.swagger';

export * from './payments.checkout-appointment.swagger';
